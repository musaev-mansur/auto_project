    ...
    const fetchCar = async () => {
      ...
      try {
        ...
        setCarData({
          ...
          bodyType: transformedCar.bodyType,
          power: transformedCar.power.toString(),
          engineVolume: transformedCar.engineVolume.toString(),
          euroStandard: transformedCar.euroStandard,
  ...
  const updateCar = async (status: 'draft' | 'published') => {
    ...
    try {
      const finalCarData = {
        ...
        engineVolume: parseFloat(carData.engineVolume),
