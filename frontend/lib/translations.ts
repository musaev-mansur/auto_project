...
export const getUIText = (key: string, locale: Locale = 'ru') => {
  const uiMaps = {
    ru: {
      ...
      // Hero section
      'hero.title': 'Автозапчасти и автомобили',
      'hero.subtitle': 'Найдите нужные запчасти или продайте свой автомобиль быстро и безопасно',
    ...
    en: {
      ...
      // Hero section
      'hero.title': 'Auto Parts and Cars',
      'hero.subtitle': 'Find the parts you need or sell your car quickly and safely',
    ...
    nl: {
      ...
      // Hero sectie
      'hero.title': 'Auto-onderdelen en auto\'s',
      'hero.subtitle': 'Vind de onderdelen die je nodig hebt of verkoop je auto snel en veilig',
    ...
    fr: {
      ...
      // Section Hero
      'hero.title': 'Pièces auto et voitures',
      'hero.subtitle': 'Trouvez les pièces dont vous avez besoin ou vendez votre voiture rapidement et en toute sécurité',
