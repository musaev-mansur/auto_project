...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,backend,8000,carspark.be').split(',')
...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,https://carspark.be').split(',')
...
if USE_S3 and AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY:
    ...
    AWS_DEFAULT_ACL = None  # Отключаем ACL для новых S3 buckets
    AWS_S3_FILE_OVERWRITE = False
    AWS_S3_VERIFY = True
    AWS_QUERYSTRING_AUTH = False
    
    # Настройки для статических файлов
    STATICFILES_STORAGE = 'carspark_backend.storage.S3StaticStorage'
    STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/static/'
    
    # Настройки для медиа файлов
    DEFAULT_FILE_STORAGE = 'carspark_backend.storage.S3MediaStorage'
